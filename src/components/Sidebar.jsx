...
const Sidebar = () => {
  ...
  const normalLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.3 rounded-lg text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2";
          ...
          dark:text-white text-slate-500"
            ...
            <TooltipComponent content="Menu" position="BottomCenter">
              <button
                type="button"
                onClick={() => {}}
                className="txet-xl rounded-full p-3
